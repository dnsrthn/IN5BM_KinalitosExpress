...
public class Productos {
    ...
    public Productos(String codigoProducto, String descripcionProducto, double precioUnitario, double precioDocena, double precioPorMayor, int existencia, int codigoTipoProducto, int codigoProveedor) {
